...
let webscraper = {
	...
	async startGame(gameDifficulty){
		...
		let startPlay = await page.$("#board-layout-sidebar > div > div.new-game-tab-component.tab-content-component > div > div > div.new-game-index-main > div.new-game-index-play > div > button")
		if(startPlay != null){
	...
	async waitForGameToStart(gameStarted){
		...
		try{
			...
			console.log("There was error in gameStarted...")
			gameStarted = false;
		}
